		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form>
					...
					<div class="col-md-3">
						<input type="text" id="b_id" name="b_id" value="<s:property value="#session['thisplan']['bid']"/>" class="form-control login-field" disabled="disabled"/>
        			</div>
        			<input type="hidden" id="pid" name="pid" value="<s:property value="#session['thisplan']['id']"/>"/>
        			<br/>
        			<br/>
        			<div class="col-md-4">
        				店名:
        			...
        			<div class="col-md-6">
						<input type="text" id="b_name" name="b_name" value="<s:property value="#session['branchName']"/>" class="form-control login-field" disabled="disabled"/>
					</div>
					<br/>
        			<br/>
        			<div class="col-md-4">
			...
			<div class="modal-footer">
				...
				<s:if
					...
					<button type="button" class="btn btn-primary" name="updatePlan"
						id="updatePlan">修改计划</button>
				</s:if>
				<%
					}
				%>
